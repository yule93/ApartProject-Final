      ...
      <b-col cols="8">
        <b-card-group deck>
          <b-card
            ...
            img-src="https://source.unsplash.com/rEn-AdBr3Ig/600x300"
            img-alt="Image"
            img-top
            tag="article"
          ...
          <b-card
            title="코로나 선별 진료소"
            img-src="https://source.unsplash.com/mAGZNECMcUg/600x300"
            img-alt="Image"
            img-top
            tag="article"
            style="max-width: 20rem"
          ...
          >
            <b-card-text>
              COVID-19는 일상 생활이 바뀔 만큼 큰 영향을 끼쳤습니다. 혹시 감염
